...
//获取一言
fetch('https://v1.hitokoto.cn?max_length=24&c=i&c=k')
...
const add_id = "mdyzvlgztyfk9znj"; // app_id
const app_secret = "Uxlmek93Mzl2elRRS085V2dsZDFDUT09"; // app_secret
const key = "d865eee8ca7c4e358943c2ba37dbe95e" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change1").html("A normal middle school student in PRC.");
    }
});
